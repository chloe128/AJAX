...
var API_KEY = "live_RNgAGeuGRjyhsP8qY77gYToskB1ksyARKqhzBZvJ1tzQTJLa2JPfe6CC2HuRySAg";
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 6:
          ...
          initialCar = data[0].id;
          _context3.next = 13;
          return loadCat(initialCar);
        case 13:
          _context3.next = 18;
          break;
        case 15:
          ...
          console.error("initialLoad failed", _context3.t0);
        case 18:
        case "end":
...
breedSelect.addEventListener("change", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  ...
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        breedId = event.target.value; //console.log(breedId); //first 4 character:abys
        _context.next = 3;
        return loadCat(breedId);
      case 3:
      case "end":
...
function loadCat(_x) {
  return _loadCat.apply(this, arguments);
}
/**
 ...
 */
function _loadCat() {
  _loadCat = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(breedId) {
    var response, data, breedsData, desc;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 6:
          ...
          breedsData = data[0].breeds[0];
          desc = document.createElement("div");
          desc.innerHTML = "<h2><b>Breed: </b>".concat(breedsData.name, "</h2>\n    <p><b>Description: </b>").concat(breedsData.description, "</p>\n    <p><b>Life Span: </b>").concat(breedsData.life_span, "</p>\n    <p><b>Origin: </b>").concat(breedsData.origin, "</p>\n    <p><b>temperament: </b>").concat(breedsData.temperament, "</p>");
          infoDump.appendChild(desc);
          //For each object in the response array, create a new element for the carousel.

          data.forEach(function (ele, index) {
            var newCarouselEle = Carousel.createCarouselItem(
            //imgSrc, imgAlt, imgId
            ele.url, ele.breeds[0].name, ele.id);
            var favButton = newCarouselEle.querySelector(".favourite-button");
            favButton.addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
              ...
              return _regeneratorRuntime().wrap(function _callee4$(_context4) {
                while (1) switch (_context4.prev = _context4.next) {
                  case 0:
                    _context4.next = 2;
                    return favourite(ele.id);
                  case 2:
                    isFavorited = _context4.sent;
                    if (isFavorited) {
        ...
        case 17:
          ...
          "Load breed info failed", _context5.t0;
        case 20:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 3:
          ...
          fav = response.data;
          findFav = fav.find(function (f) {
            return f.image_id == imgId;
          });
          if (!findFav) {
            _context6.next = 12;
            break;
          ...
          _context6.next = 9;
          return _axios.default.delete("/favourites/".concat(findFav.id));
        case 9:
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 12:
          _context2.prev = 12;
          _context2.t0 = _context2["catch"](0);
          console.error("initialLoad failed", _context2.t0);
        case 15:
        case "end":
          return _context2.stop();
      }
...
function _loadCat() {
  _loadCat = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(breedId) {
    var response, data, breedsData, desc;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return _axios.default.get("https://api.thecatapi.com/v1/images/search?limit=10&breed_ids=".concat(breedId), {
            headers: {
              "x-api-key": API_KEY
            },
        ...
        case 16:
          _context3.prev = 16;
          _context3.t0 = _context3["catch"](0);
          "Load breed info failed", _context3.t0;
        case 19:
        case "end":
          return _context3.stop();
      }
...
_axios.default.interceptors.request.use(function (config) {
  ...
  console.log("Starting request to ".concat(config.url, " at ").concat(config.metadata.startTime));
  return config;
}, function (error) {
  return Promise.reject(error);
});
...
_axios.default.interceptors.response.use(function (response) {
  ...
  console.log("Request to ".concat(response.config.url, " completed in ").concat(duration, "ms"));
...
function updateProgress(event) {
  ...
  if (event.lengthComputable) {
    ...
    console.log("Progress: ".concat(percentCompleted, "%"));
  } else {
